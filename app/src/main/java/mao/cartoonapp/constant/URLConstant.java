...
public class URLConstant
{
    ...
    public static final String host = "m.qiman59.com";
    public static final String bookChapterUrl = "http://m.qiman59.com/bookchapter/";

    public static final String searchUrl = "http://m.qiman59.com/spotlight/?keyword=";

    public static final String rank1Name = "日热门榜";
    public static final String rankUrl1 = "http://m.qiman59.com/rank/1-1.html";
    public static final int rankUrl1Type = 1;

    public static final String rank2Name = "周热门榜";
    public static final String rankUrl2 = "http://m.qiman59.com/rank/2-1.html";
    public static final int rankUrl2Type = 2;

    public static final String rank3Name = "月热门榜";
    public static final String rankUrl3 = "http://m.qiman59.com/rank/3-1.html";
    public static final int rankUrl3Type = 3;

    public static final String rank4Name = "总热门榜";
    public static final String rankUrl4 = "http://m.qiman59.com/rank/4-1.html";
    public static final int rankUrl4Type = 4;

    public static final String rank5Name = "最近更新";
    public static final String rankUrl5 = "http://m.qiman59.com/rank/5-1.html";
    public static final int rankUrl5Type = 5;

    public static final String rank6Name = "新漫入库";
    public static final String rankUrl6 = "http://m.qiman59.com/rank/6-1.html";
